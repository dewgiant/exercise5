...
WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_firstName'), 'DEW')

WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_lastName'), 'TIA')
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Swag Labs/button_Add to Cart'), 10)
